    ...
    <div className="min-h-screen bg-[#F9F8F6] flex flex-col font-sans relative overflow-hidden text-gray-900">
      ...
      <nav className="w-full px-8 py-6 flex justify-between items-center z-10">
        ...
        <div className="flex gap-4">
          ...
          <button 
            onClick={() => window.open('https://github.com/KaranKalra09/synapse', '_blank')}
            className="px-5 py-2 text-sm font-bold bg-gray-900 text-white rounded-full hover:bg-gray-800 transition-all flex items-center gap-2 shadow-sm"
          >
